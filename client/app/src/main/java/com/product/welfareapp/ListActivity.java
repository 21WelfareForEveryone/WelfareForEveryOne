...
import static com.product.welfareapp.URLs.url_welfare_search;
...
public class ListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            requestCategoricalWelfareInfo(token, category, new VolleyCallBack() {
                @Override
                public void onSuccess() {
                    updateCategoricalWelfareOnUI(token, category);
                }
            });
    ...
    public void updateCategoricalWelfareOnUI(String token, int category){
        SharedPreferences categoricalWelfareInfo = getSharedPreferences("categoricalWelfareInfo", MODE_PRIVATE);

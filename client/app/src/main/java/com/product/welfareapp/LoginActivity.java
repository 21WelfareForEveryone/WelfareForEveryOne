...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                userLoginVer2(new VolleyCallBack(){
                    ...
                    public void onSuccess() {
                        ...
                        if(isSuccess){
                            ...
                            Intent intent = new Intent(LoginActivity.this, com.product.welfareapp.MainActivity.class);
                            if(bundle!=null){
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(LoginActivity.this, com.product.welfareapp.RegisterActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    public synchronized void userLoginVer2(final VolleyCallBack volleyCallBack){
        ...
        final JsonObjectRequest jsonRequest = new JsonObjectRequest(Request.Method.POST, com.product.welfareapp.URLs.url_login, params, new Response.Listener<JSONObject>(){
            @Override

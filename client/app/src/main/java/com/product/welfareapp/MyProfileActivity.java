            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(item.getItemId()){
                    case R.id.navigation_1:
                        Intent intent1 = new Intent(MyProfileActivity.this, com.product.welfareapp.MainActivity.class);
                        intent1.putExtras(bundle);
                        startActivity(intent1);
                        finish();
                        return true;
                    case R.id.navigation_2:
                        Intent intent2 = new Intent(MyProfileActivity.this, com.product.welfareapp.ChatActivity.class);
                        intent2.putExtras(bundle);
                        startActivity(intent2);
                        finish();
                        return true;
                    case R.id.navigation_3:
                        Intent intent3 = new Intent(MyProfileActivity.this, com.product.welfareapp.MapActivity.class);
